// Write a program that takes a string as input and you will be given a string "He l lo". Your task is to determine its length (the number of characters it contains).
